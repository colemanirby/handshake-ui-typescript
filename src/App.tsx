...
class App extends Component {
    ...
    state: {
        ...
        authNavBarOptions: string[],
        unAuthNavBarOptions: string[],
        navBarElements: any[],
        isModalOpen: boolean
    };
    ...
    buildLoggedInNavBar(): any[] {
        let navOptionsArray: any[] = [];
        let key = 1;
        ...
        return (
            ...
            (
                <div className="App container">
                    ...
                    <Navbar fluid={false} collapseOnSelect={false}>
                        <Navbar.Header>
                            <Navbar.Brand>
